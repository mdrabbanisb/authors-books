            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="authorsSubmenu">
                        <li><a href="{{ route('admin.authors.index') }}"><i class="fas fa-list"></i> All Authors</a></li>
                        <li><a href="{{ route('admin.authors.create') }}"><i class="fas fa-user-plus"></i> Add New Author</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="booksSubmenu">
                        <li><a href="{{ route('admin.books.index') }}"><i class="fas fa-list"></i> All Books</a></li>
                        <li><a href="{{ route('admin.books.create') }}"><i class="fas fa-plus-circle"></i> Add New Book</a></li>
                    </ul>
                </li>
